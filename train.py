...
def train():
    ...
    train = datasets.labelandID(args.dir, './../../GAN/text_file/out_attr.txt', args.im_num, args.depth)
    train = chainer.datasets.LabeledImageDataset(pairs=train, root='resized_images')
